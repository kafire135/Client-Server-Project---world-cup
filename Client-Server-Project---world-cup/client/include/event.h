...
public:
    ...
    void set_game_updates(std::string key, std::string value);
    void set_team_a_updates(std::string key, std::string value);
    void set_team_b_updates(std::string key, std::string value);
};
